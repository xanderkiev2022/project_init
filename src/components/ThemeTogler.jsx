...
import { Input, Svg } from './ThemeTogler.styled';
import icon from './ThemeToglerIcon.svg';

const LS_KEY = 'darkTheme';

export const ThemeTogler = () => {
  const [darkTheme, setDarkTheme] = useState(localStorage.getItem(LS_KEY) === 'true' || false);
